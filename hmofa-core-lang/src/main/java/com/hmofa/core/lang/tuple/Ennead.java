...
public class Ennead<A, B, C, D, E, F, G, H, I> extends Tuple implements Value0<A>, Value1<B>, Value2<C>, Value3<D>, Value4<E>, Value5<F>, Value6<G>,
		Value7<H>, Value8<I> {
	...
	public Ennead(final A value0, final B value1, final C value2, final D value3, final E value4, final F value5, final G value6, final H value7,
			final I value8) {
	...
	private static final long serialVersionUID = -6485892768260606823L;
