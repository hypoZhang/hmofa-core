...
public class Octet<A, B, C, D, E, F, G, H> extends Tuple implements Value0<A>, Value1<B>, Value2<C>, Value3<D>, Value4<E>, Value5<F>, Value6<G>,
		Value7<H> {
	...
	private static final long serialVersionUID = -8238862848862828995L;
